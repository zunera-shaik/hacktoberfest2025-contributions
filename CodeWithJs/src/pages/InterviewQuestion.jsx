...
import { BsBriefcase, BsSearch, BsArrowLeft } from 'react-icons/bs';
        ...
        <Row className="mb-4">
          <Col>
            ...
            <div className="d-flex align-items-center mb-3">
              <BsBriefcase className="me-3 fs-1 text-danger" />
              <div>
            ...
            <p className={`lead ${theme === 'dark' ? 'text-muted' : 'text-secondary'}`}>
              Prepare for your next job interview with these commonly asked JavaScript 
              interview questions covering advanced concepts, problem-solving, and coding challenges.
            </p>
          </Col>
        </Row>
