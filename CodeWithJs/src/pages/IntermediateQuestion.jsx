...
import { BsBookHalf, BsSearch, BsArrowLeft } from 'react-icons/bs';
...
const IntermediateQuestions = () => {
  ...
  const filteredQuestions = intermediateQuestions.filter(question =>
      ...
      <Container className="py-5">
        ...
        <Row className="mb-4">
          <Col>
            ...
            <div className="d-flex align-items-center mb-3">
              <BsBookHalf className="me-3 fs-1 text-info" />
              <div>
            ...
            <p className={`lead ${theme === 'dark' ? 'text-muted' : 'text-secondary'}`}>
              Strengthen your JavaScript knowledge with these intermediate-level questions, 
              focusing on closures, promises, async programming, event delegation, and DOM manipulation.
            </p>
          </Col>
        </Row>
        ...
        {currentQuestions.length > 0 ? (
          <QuestionAccordion
            ...
            icon={BsBookHalf}
            badgeColor="info"
            sectionId="intermediate-questions"
          />
        ) : (
